import {BeakerIcon,CheckBadgeIcon,ChevronDownIcon,HomeIcon,StarIcon,UserIcon,} from '@heroicons/react/24/solid'
      ...
      <div className='flex-1 max-w-lg'>
        ...
        <div>
          ...
          <div className='flex flex-col items-start pb-4 mx-auto my-2 max-w-7xl sm:flex-row'>
            ...
            <div className='flex-grow prose sm:text-left prose-md'>
              <p className='text-gray-500 text-xl'>{homeData?.host?.name} is a Super host</p>
              <p className='text-gray-400'>
